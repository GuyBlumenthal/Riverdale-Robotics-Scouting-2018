...
public class CreateMatch {
	...
	private void initialize() {
		...
		pnlBlueTeam.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), "Blue Alliance", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 0)));
		...
		pnlRedTeam.setBorder(new TitledBorder(null, "Red Alliance", TitledBorder.LEADING, TitledBorder.TOP, null, null));
